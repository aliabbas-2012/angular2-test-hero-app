...
@Component({
  selector: 'hero-ob-search',
  templateUrl: './hero-search-ob.component.html',
  styleUrls: [ './hero-search.component.css' ],
  providers: [HeroSearchService]
})
export class HeroSearchObComponent implements OnInit {
    ...
    ngOnInit():void{
      ...
      .switchMap(term => term   // switch to new observable each time the term changes
        ...
        ? this.heroSearchService.searchOb(term)
